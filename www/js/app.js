...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'firebase', 'ionic.service.core','ngCordova','ionic.service.push'])


.run(function($ionicPlatform, $ionicLoading, $rootScope, $ionicLoading, $window, $localstorage,$cordovaSQLite,$ionicPush) {
  $ionicPlatform.ready(function() {
    ...
    if (window.StatusBar) {
      ...
      db = $cordovaSQLite.openDB("quirquinchosantov2.db"); //device
...
.config(function($stateProvider, $urlRouterProvider, $ionicAppProvider) {
   ...
   $ionicAppProvider.identify({
    ...
    api_key: '523013e0ef3883ba0c24af5b1a3236b563bb0970ac4d1c0f',
